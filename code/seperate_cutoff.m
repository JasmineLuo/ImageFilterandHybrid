...
image1 = im2single(imread('file:///Users/luozhongyi/Desktop/2015%20Fall%20course/CS%206476/proj1/data/marilyn.bmp'));
image2 = im2single(imread('file:///Users/luozhongyi/Desktop/2015%20Fall%20course/CS%206476/proj1/data/einstein.bmp'));
...
cutoff_frequency1 = 6; %to use alternate values
cutoff_frequency2 = 4;
...
low_frequencies = my_imfilter2(image1, filter1);
...
high_frequencies = image2-my_imfilter2(image2, filter2);
