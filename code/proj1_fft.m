...
image1 = im2single(imread('file:///Users/luozhongyi/Desktop/2015%20Fall%20course/CS%206476/proj1/data/dog.bmp'));
image2 = im2single(imread('file:///Users/luozhongyi/Desktop/2015%20Fall%20course/CS%206476/proj1/data/cat.bmp'));
...
cutoff_frequency = 1; %This is the standard deviation, in pixels, of the 
...
high_frequencies = image2(:,1:361,:)-my_imfilter_fft(image2, 8);
...
%% see the effects in frequency level and try to filter in frequency domain
