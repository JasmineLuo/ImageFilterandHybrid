...
image1 = im2single(imread('file:///Users/luozhongyi/Desktop/2015%20Fall%20course/CS%206476/proj1/data/fish.bmp'));
image2 = im2single(imread('file:///Users/luozhongyi/Desktop/2015%20Fall%20course/CS%206476/proj1/data/submarine.bmp'));
...
cutoff_frequency = 6.5; %to use alternate values
...
low_frequencies = my_imfilter2(image1, filter);
...
high_frequencies = image2-my_imfilter2(image2, filter);
